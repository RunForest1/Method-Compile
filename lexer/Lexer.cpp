...
void Lexer::initTable() {
    ...
    // Из начального состояния S_START
    ...
    table[{S_START, C_SPACE}]  = S_START; // Пробелы игнорируются 
    ...
    // Промежуточное состояние после точки
    ...
    table[{S_COMMENT_ENDING, C_STAR}]  = S_COMMENT_ENDING; // продолжение
}
...
Token Lexer::nextToken() {
    ...
    while (currentState != S_FINAL) {
        ...
        // Если перехода нет
            ...
            // Если перехода нет — это финальное состояние 
