...
enum State {
    S_START, S_ID, S_INT, S_FLOAT, S_STRING, S_COLON, S_NOT, 
    S_COMP_OP, S_SLASH, S_COM_B, S_COM_E, S_F, S_F_B, S_ERROR
};

// Категории символов (пункт 1.3)
enum CharClass {
    C_LETTER, C_DIGIT, C_DOT, C_QUOTE, C_COLON, C_NOT, C_EQUAL,
    C_COMPARE, C_SLASH, C_ASTERISK, C_ADDITIVE, C_DELIMITER, 
    C_SPACE, C_TERMINATOR, C_OTHER, C_COUNT
};
